...
'''
    ...
    150507-1751 == 
    Да.. Расширяется кругозор.. Вот, узнал слово "жмудь".

    TODO Найти словарь, состоящий только из существительных.
    TODO Проверить, как скрипт работет под linux.
    FIXME После добавления новой строки в начало словаря 
...
if not os.path.isfile(os.getcwd()+'\\'+dictName): 
...
print '    trueWords:'
if trueWords: 
    try: printl(trueWords)
    except: print 'ERROR with coding in DOS OEM 866. Shit. Try another console' 
